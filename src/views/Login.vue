...
const rules={
    ...
    rePassword:[
        {validator:checkRePassword,tirgger:'blur'}
    ]
}

//
import {userRegisterSevice,userLoginService} from '@/api/user.js'
const  register =async()=>{
    //
    let result = await userRegisterSevice(registerData.value)
    // if(result.code === 0){
    //     //
